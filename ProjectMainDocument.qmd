...
8.  Can we predict the duration of hospital stay based on initial serum creatinine levels and platelet counts?

9.  What are the primary factors associated with abnormal serum sodium levels in heart failure patients?

10. Which attribute has the greatest effect on chances of dying from heart failure?

11. Which attributes have the most samples outside the healthy range?

12. Is there a relation between smoking and creatinine phosphokinase, serum creatine, and serum sodium levels?

13. What are the healthy ranges of the attributes?

14. How are the rates of death from heart failure and smoking related?

15. How does Creatinine Phosphokinase affect the rate of survival of heart failure?

16. What is the variation for death by heart failure by demographic (gender, smoking, etc)?

17.  Are there specific subgroups within the population that are at higher risk of developing heart failure?

18.  Which factors have the greatest influence on long-term outcomes, and how do they change over time?

19. What is the distribution of age among patients who experienced a heart failure death event?

20. How does anaemia affect the mortality rate in heart failure patients?

    To answer this question, we will use a logistic regression model. This is because we have two categorical variables and we want to see the relationship between them.

    ```{r}
    model <- glm(DEATH_EVENT ~ anaemia, data = heart, family = binomial)
    summary(model)
    ```

21. Does having diabetes increase the risk of death in heart failure patients?

    We can use a logistic regression model to see if diabetes has an effect on death rates from heart failure because both diabetes and DEATH_EVENT are categorical variables.

    ```{r}

    ```

22. What are the typical ejection fraction values in patients who survive vs. those who don't?

23. How does high blood pressure impact the survival rates of heart failure patients?

24. Are lower platelet counts associated with higher mortality in heart failure patients?

25. What role does serum creatinine play in predicting heart failure outcomes?

26. How does serum sodium concentration relate to heart failure mortality?

27. Does the gender or smoking status of a patient significantly influence heart failure outcomes?
