...
ggplot(heart, aes(y = creatinine_phosphokinase)) +
  geom_boxplot() +
...
ggplot(heart, aes(y = ejection_fraction)) +
  geom_boxplot() +
  labs(title = "Boxplot of Ejection Fraction", y = "Ejection Fraction")
```
...
```{r}
cor_cpk_ef <- cor(heart$creatinine_phosphokinase, heart$ejection_fraction)
cor_cpk_p <- cor(heart$creatinine_phosphokinase, heart$platelets)
cor_cpk_sc <- cor(heart$creatinine_phosphokinase, heart$serum_creatinine)
cor_cpk_ss <- cor(heart$creatinine_phosphokinase, heart$serum_sodium)

print(paste("Correlation between creatinine_phosphokinase and ejection_fraction:", cor_cpk_ef))
print(paste("Correlation between creatinine_phosphokinase and platelets:", cor_cpk_p))
print(paste("Correlation between creatinine_phosphokinase and serum_creatinine:", cor_cpk_sc))
print(paste("Correlation between creatinine_phosphokinase and serum_sodium:", cor_cpk_ss))
...
cor_cpk_t <- cor(heart$creatinine_phosphokinase, heart$time)
cor_ef_p <- cor(heart$ejection_fraction, heart$platelets)
cor_ef_sc <- cor(heart$ejection_fraction, heart$serum_creatinine)
cor_ef_ss <- cor(heart$ejection_fraction, heart$serum_sodium)

print(paste("Correlation between creatinine_phosphokinase and time:", cor_cpk_t))
print(paste("Correlation between ejection_fraction and platelets:", cor_ef_p))
print(paste("Correlation between ejection_fraction and serum_creatinine:", cor_ef_sc))
print(paste("Correlation between ejection_fraction and serum_sodium:", cor_ef_ss))
